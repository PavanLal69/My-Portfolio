    ...
    <group position={point.point} scale={isMobile ? 0.35 : 0.6}>
      ...
      <group>
        <group position={getPoint}>
          <Text {...textProps} fontSize={0.28} maxWidth={4} position={[-diff / 2, 0, 0]}>
            {point.year}
          </Text>
          <group position={[0, -0.85, 0]}>
            <Text {...titleProps} fontSize={0.5} maxWidth={2.8} position={[0, -diff / 2, 0]}>
              {point.title}
            </Text>
            <Text {...textProps} fontSize={0.22} position={[0, -0.55 - diff, 0]}>
              {point.subtitle}
            </Text>
          </group>
        </group>
